...
(
	...
	AUD_SEQ_ID NUMERIC(18) NOT NULL, -- SEQUENCE OF THE AUDIT
...
SET TERM !!;
CREATE TRIGGER TG_AUD_TBL_SEQ FOR AUD_TBL ACTIVE BEFORE INSERT POSITION 0 AS BEGIN
	NEW.AUD_SEQ_ID = NEXT VALUE FOR AUD_SEQ;
END!!
SET TERM ; !!
...
INSERT INTO AUD_CD_TBL (CD_ID, MNEMONIC, DOMAIN, DISPLAY) VALUES (gen_uuid(), '1','RFC-3881','MEDICAL RECORD');
INSERT INTO AUD_CD_TBL (CD_ID, MNEMONIC, DOMAIN, DISPLAY) VALUES (gen_uuid(), '2','RFC-3881','PATIENT NUMBER');
INSERT INTO AUD_CD_TBL (CD_ID, MNEMONIC, DOMAIN, DISPLAY) VALUES (gen_uuid(), '3','RFC-3881','ENCOUNTER NUMBER');
INSERT INTO AUD_CD_TBL (CD_ID, MNEMONIC, DOMAIN, DISPLAY) VALUES (gen_uuid(), '4','RFC-3881','ENROLLEE NUMBER');
INSERT INTO AUD_CD_TBL (CD_ID, MNEMONIC, DOMAIN, DISPLAY) VALUES (gen_uuid(), '5','RFC-3881','SOCIAL SECURITY NUMBER');
INSERT INTO AUD_CD_TBL (CD_ID, MNEMONIC, DOMAIN, DISPLAY) VALUES (gen_uuid(), '6','RFC-3881','ACCOUNT NUMBER');
INSERT INTO AUD_CD_TBL (CD_ID, MNEMONIC, DOMAIN, DISPLAY) VALUES (gen_uuid(), '7','RFC-3881','GUARANTOR NUMBER');
INSERT INTO AUD_CD_TBL (CD_ID, MNEMONIC, DOMAIN, DISPLAY) VALUES (gen_uuid(), '8','RFC-3881','REPORT NAME');
INSERT INTO AUD_CD_TBL (CD_ID, MNEMONIC, DOMAIN, DISPLAY) VALUES (gen_uuid(), '9','RFC-3881','REPORT NUMBER');
INSERT INTO AUD_CD_TBL (CD_ID, MNEMONIC, DOMAIN, DISPLAY) VALUES (gen_uuid(), '10','RFC-3881','SEARCH CRITERION');
INSERT INTO AUD_CD_TBL (CD_ID, MNEMONIC, DOMAIN, DISPLAY) VALUES (gen_uuid(), '11','RFC-3881','USER IDENTIFIER');
INSERT INTO AUD_CD_TBL (CD_ID, MNEMONIC, DOMAIN, DISPLAY) VALUES (gen_uuid(), '12','RFC-3881','URI');
